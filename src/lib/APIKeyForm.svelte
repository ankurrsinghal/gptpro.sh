...
<div class="relative flex items-center mx-auto w-full max-w-xl px-2.5 sm:px-0">
	...
	<input
		...
		class="peer block w-full rounded-md border border-gray-200 bg-white p-2 pl-10 pr-12 text-sm shadow-lg focus:border-black focus:outline-none focus:ring-0"
	/>
</div>
{#if isError}
...
<div class="mx-auto mt-10 flex max-w-fit space-x-4">
	<button
		...
		{disabled}
		class="flex items-center justify-center rounded-full border border-black bg-black py-2 px-5 text-white shadow-lg transition-all hover:bg-white hover:text-black"
